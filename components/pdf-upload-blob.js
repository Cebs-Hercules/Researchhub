...
import { uploadPdfToBlob } from "@/app/actions/blob-actions"
import { Loader2, Upload, X, Check, FileText } from "lucide-react"

export default function PdfUploadBlob({ onUploadSuccess, existingPdfUrl = null, existingFilename = null }) {
  ...
  const handleUpload = async (file) => {
    ...
    try {
      ...
      const result = await uploadPdfToBlob(formData)
